...
# Import scan matching functions
import sys
import os
...
class ICPNode(Node):
    ...
    def laser_scan_callback(self, msg):
        ...
        initial_points = point_cloud.shape[0] # number of points in scan
        ...
        final_points = point_cloud.shape[0] # number of points after filtering
